def get_mask_card_number(card_number: int) -> str:
    """Функция принимает номер карты в виде числа и возврвщвет маску карты в виде XXXX XX** **** XXXX"""
    # Преобразуем номер в строку
    card_number_str = str(card_number)
    mask_cardnumber = ''.join(card_number_str[:4] + " " + card_number_str[4:6] + "** ****"+ " " + card_number_str[12:])
