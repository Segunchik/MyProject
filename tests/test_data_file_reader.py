...
def test_excel_reader_success():
    excel_data = pd.DataFrame({"name": ["Анна", "Борис"], "age": [25, 30], "city": ["Москва", "Санкт-Петербург"]})

    with patch("pandas.read_excel") as mock_read_excel:
        mock_read_excel.return_value = excel_data
        result = excel_reader("test.xlsx")

    expected = [{"name": "Анна", "age": 25, "city": "Москва"}, {"name": "Борис", "age": 30, "city": "Санкт-Петербург"}]
